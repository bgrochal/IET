package pl.edu.agh.age.function.rosenbrock.agent.generator;

import pl.edu.agh.age.compute.stream.emas.EmasAgent;
import pl.edu.agh.age.compute.stream.emas.solution.DoubleVectorSolution;
import pl.edu.agh.age.compute.stream.emas.solution.Solution;
import pl.edu.agh.age.function.rosenbrock.evaluator.RosenbrockEvaluator;
 ...
 */
public class RandomRosenbrockAgentGenerator {
    ...
    private static Solution<?> getRandomSolution(ThreadLocalRandom randomGenerator) {
        final RosenbrockEvaluator rosenbrockEvaluator = new RosenbrockEvaluator();
        final double[] solutionArray = IntStream.range(0, 2)
                .mapToDouble(index -> 1 + 5 * randomGenerator.nextDouble(-1, 1))
                .toArray();

        return new DoubleVectorSolution(solutionArray, rosenbrockEvaluator.evaluate(solutionArray));
    }
